...
/**
 * Contact
 * Configurable contact section — same visual as the original.
 * Each page passes its own CTA copy; all link to the same WhatsApp.
 *
 * Props:
 *   ctaTitle   — large left-column headline
 *   ctaSubtitle — paragraph below headline
 *   ctaButton   — button label
 *   waMessage   — pre-filled WhatsApp message
 */
export function Contact({
  ...
  return (
    <section
      id="kontak"
      className="bg-white dark:bg-primary-950 py-20 md:py-24 lg:py-[160px] px-5 md:px-6 lg:px-8 overflow-hidden transition-colors duration-300"
    >
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 min-[900px]:grid-cols-2 gap-12 min-[900px]:gap-16 items-center">
        ...
        >
          <h2
            className="font-heading text-[1.75rem] md:text-4xl lg:text-[4rem] font-bold text-primary-800 dark:text-white tracking-[-0.02em] mb-6 transition-colors duration-300"
            style={{ lineHeight: '1' }}
          >
            {ctaTitle}
          </h2>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 font-heading text-xs font-bold tracking-[0.1em] py-4 px-8 bg-primary-800 dark:bg-primary text-white no-underline transition-all duration-300 border-[1.5px] border-primary-800 dark:border-primary hover:bg-primary-900 dark:hover:bg-primary-400 hover:border-primary-900 dark:hover:border-primary-400 hover:shadow-[0_8px_24px_rgba(53,88,114,0.25)] dark:hover:shadow-[0_8px_24px_rgba(156,213,255,0.2)] hover:-translate-y-[2px] group"
          >
            <span>{ctaButton}</span>
            <svg
        ...
        >
          <div className="bg-gradient-to-br from-white to-[#f0f7fb] dark:from-primary-900 dark:to-primary-950 rounded-xl p-6 md:p-8 lg:p-12 shadow-[0_12px_40px_rgba(53,88,114,0.08)] dark:shadow-[0_12px_40px_rgba(0,0,0,0.3)] border border-white/50 dark:border-white/10 relative overflow-hidden group transition-colors duration-300">
            ...
            <h3 className="font-heading text-2xl font-bold text-primary-800 dark:text-white mb-8 relative z-10 transition-colors duration-300">
              Detail Kontak
            </h3>
              ...
              <div className="flex flex-col min-[480px]:flex-row items-start min-[480px]:items-center gap-4 min-[480px]:gap-6 py-3 transition-transform duration-300 hover:translate-x-1">
                ...
                <div className="flex flex-col gap-[2px]">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="font-body text-sm font-medium text-primary-800 dark:text-primary-300 no-underline transition-colors duration-300 hover:text-primary dark:hover:text-primary-100 break-all min-[480px]:break-normal"
                  >
                    drenacreative@gmail.com
                  </a>
                </div>
              </div>
