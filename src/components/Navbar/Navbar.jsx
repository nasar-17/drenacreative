...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    to: '/layanan-design',
    children: [
      { label: 'Poster Design', hash: 'poster-design' },
      { label: 'Banner Design', hash: 'banner-design' },
      { label: 'Feed Instagram', hash: 'feed-instagram' },
      { label: 'Logo Design', hash: 'logo-design' },
      { label: 'Branding Kit', hash: 'branding-kit' },
    ],
  },
  {
    label: 'Layanan Tugas',
    to: '/layanan-tugas',
    children: [
      { label: 'Website Tugas', hash: 'website-tugas' },
      { label: 'Presentasi / PPT', hash: 'presentasi-ppt' },
      { label: 'Makalah & Laporan', hash: 'makalah-laporan' },
      { label: 'UI/UX Project', hash: 'uiux-project' },
      { label: 'Coding Project', hash: 'coding-project' },
    ],
  },
];
